...
const ArticlesPosts = ({ data: { site, article } }) => (
  <Layout>
    <Article {...article} />
  </Layout>
)
...
export const Head = ({ data: { site, article } }) => (
  <>
    <title>{article.frontmatter.title}</title>
    <meta name="description" content={article.excerpt} />
    <meta name="keywords" content={article.frontmatter.tags} />
    <meta name="image" content={`${site.siteMetadata.siteUrl}${article.fields.slug}/twitter-card.jpg`} />
    ...
    <meta property="og:image:secure_url" content={`${site.siteMetadata.siteUrl}${article.fields.slug}/twitter-card.jpg`} />
